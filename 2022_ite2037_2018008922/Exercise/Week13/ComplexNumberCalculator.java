...
public class ComplexNumberCalculator implements Calculator{
    ...
    public ComplexNumber add(ComplexNumber c1, ComplexNumber c2){
        return new ComplexNumber(ComplexNumber.add(c1.getReal(),c2.getReal()), ComplexNumber.add(c1.getImaginary(),c2.getImaginary()));
    }
    @Override
    public ComplexNumber sub(ComplexNumber c1, ComplexNumber c2){
        return new ComplexNumber(ComplexNumber.sub(c1.getReal(),c2.getReal()), ComplexNumber.sub(c1.getImaginary(),c2.getImaginary()));
    }
    @Override
    public ComplexNumber mul(ComplexNumber c1, ComplexNumber c2){
        return new ComplexNumber(ComplexNumber.mul(c1.getReal(),c2.getReal()), ComplexNumber.mul(c1.getImaginary(),c2.getImaginary()));
    }
