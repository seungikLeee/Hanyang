...
<head>
  ...
  <script>
    function drop() {
      let dropList = document.getElementById('registeredList');
      for (let i = 1; i < dropList.rows.length; i++) {
        dropList.rows[i].cells[9].onclick = function () {
          ...
          alert("수강 취소합니다.");
          document.location.href="dropAction.jsp?classid=" + classid;
        }
      }
    }
  </script>
...
<div class="container">
  <div class="col">
    <table id = "userInfo" class="table" width ="1500" style="text-align: center; border: 1px solid #dddddd">
      <thead>
      <tr>
        <th style="text-align: center;"> 수강 신청 내역 </th>
      </tr>
...
<div class="container">
  <div class="row">
    <table id = "registeredList" class="table" width ="1500" style="text-align: center; border: 1px solid #dddddd">
      <thead>
      <tr>
        ...
        <th style="text-align: center;">  수강 신청 취소  </th>
        <th style="text-align: center;">   </th>
      </tr>
      ...
      <tbody>
      <%
        ArrayList<RegisteredCourse> registeredList = userDAO.showRegisteredCourses(studentID);
        int j=1;
        for(int i = 0; i< registeredList.size(); i++){

          ArrayList<ClassInfo> classList = userDAO.searchResult(registeredList.get(i).getClassID(),null,null, 5);
          ...
          %>    <tr>
                  ...
                  <td><button type="button" class="navyBtn" onClick="drop()">수강 신청 취소</button></td>
                </tr>
            <%
              k++;
              }
...
<div class="container">
  <div class="col">
    <table id = "creditSum" class="table" width ="1500" style="text-align: right; border: 1px solid #dddddd">
      <thead>
      <tr>
        <th style="text-align: right;">    총 수강 신청 학점     </th>
      </tr>
